...

{
  ...
  niks3 = {
    ...
    niks3-signing-key = config.age.secrets.niks3-auth-token.path;
    niks3-s3-access-key = config.age.secrets.niks3-auth-token.path;
    niks3-s3-secret-key = config.age.secrets.niks3-auth-token.path;
  };
}
